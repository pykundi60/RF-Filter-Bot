...
➥ Cʀᴇᴀᴛᴏʀ: <a href='https://t.me/HMF_BotzZ'>HMF BotzZ</a>
...
<b>DEVS:</b>
- <a href='https://t.me/HMF_Owner_1'>Thiru | HMF | 🇬🇷 |</a>"""
...
• /broadcast - to broadcast a message to all users."""
    ...
    STATUS_TXT = """<b>📁 Tᴏᴛᴀʟ Fɪʟᴇ : </b> <code>{}</code>

<b>👤 Tᴏᴛᴀʟ Usᴇʀ : </b> <code>{}</code>

<b>👥 Tᴏᴛᴀʟ Cʜᴀᴛs : </b> <code>{}</code>

<b>⚙️ Usᴇᴅ Sᴛᴏʀᴀɢᴇ : </b> <code>{}</code> MiB

<b>🆓 Tᴏᴛᴀʟ Sᴛᴏʀᴀɢᴇ : </b> <code>{}</code> MiB
